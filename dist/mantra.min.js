'use strict';(function(h) {
  ...
  b.define("Mantra.gestures.Dispecher", {singleton:!0, constructor:function() {
  ...
  b.relayMethod(b, b.gestures.Dispecher, "on");
  b.relayMethod(b, b.gestures.Dispecher, "off");
  b.relayMethod(b, b.gestures.Dispecher, "register");
