...
(function(k) {
  ...
  c.define("Mantra.GesturesDispatcher", {singleton:g, constructor:function() {
    ...
    if(this.h[a]) {
      ...
      f = e.listeners[a];
      d = f.indexOf(d);
      -1 < d && (e[a] = f.splice(d, 1), this.l--, this.h[a].C--, a = e.listeners.count, a--, a || (b[0].style.msTouchAction = n, this.B(c.d[c.c], b)), 0 === this.l && this.B(c.d[c.b] + " " + c.d[c.a]))
    }
  }, r:function(a, b) {
    b || (b = c.q);
    b.on(a, this.m)
        ...
        if(h && h.listeners) {
          for(var k in h.listeners) {
            if(h.listeners.hasOwnProperty(k)) {
              var l = h.listeners[k], m = this.h[k].gesture;
    ...
    return{type:a, w:p, preventDefault:function() {
      this.w = g
    }, isDefaultPrevented:function() {
      return this.w
    }, A:p, stopPropagation:function() {
      this.A = g
    ...
    if(!a.originalEvent._mantraHandled) {
      ...
      this.i && this.i != d || !this.i && b != c.c || (this.M(a), b == c.c ? (this.i = d, this.o(a)) : b == c.b ? this.o(a) : b == c.a && (this.k.length || (this.i = p), this.o(a)))
    }
  }, J:function(a) {
    a.N && (a = a.N);
    ...
    a = a.originalEvent;
    c.e.pointerevents ? a = c["POINTER_" + c.D[a.pointerType]] : (a = a.type, a = 0 == a.indexOf("touch") ? c.G : c.F);
    return a
  }, L:function(a) {
    a = a.originalEvent;
    a = a.type;
  ...
  c.define("Mantra.Gesture", {singleton:g, "abstract":g, name:n, constructor:function() {
    ...
    this.u = b;
    var d;
    if(b.fingers.length != this.fingers && a.phase != c.a) {
      return this.f = this.u = n, p
    }
    switch(a.phase) {
      case c.b:
        var e = this.s();
        ...
        break;
      case c.a:
        e = this.s(), d = this.H(), d = e && d
    }
    d !== p && "process" in this && (d = this.process.apply(this, arguments));
    this.f = this.u = n;
    return d
  }, s:function() {
    return this.maxDelta !== n && this.f.deltaTotal > this.maxDelta || this.minDelta !== n && this.f.deltaTotal < this.minDelta ? p : g
  }, H:function() {
    return this.maxDelay !== n && this.f.time > this.maxDelay || this.minDelay !== n && this.f.time < this.minDelay ? p : g
  }, statics:{}});
  ...
  c.define("Mantra.gestures.Hold", {extend:"Mantra.gestures.Tap", name:"hold", minDelay:300, maxDelay:1E3, constructor:function() {
    this.j.apply(this)
  }})
}).call(this, window);
